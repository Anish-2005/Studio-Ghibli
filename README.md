...
|---:|:---:|:---|
| ![browse](public/screen-browse.png) | ![create](public/screen-create.png) | ![collect](public/screen-collect.png) |

*Images above are placeholders — drop screenshots into `public/` with the same names to show them here.*
